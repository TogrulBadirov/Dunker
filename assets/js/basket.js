...
function generateBasketElements(product) {
    ...
    <div>
      <span class="product-cost" >$${product.discount !== undefined
            ? +product.price * ((100 - product.discount) / 100)
            : product.price
        }</span>
      
      <span class="product-cost" style="color:#727272;text-decoration: line-through;">${product.discount !== undefined ? "$" + product.price : ""
